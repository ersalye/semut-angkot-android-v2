package id.pptik.semutangkot.easylogin.networks;
...
public class FacebookNetwork extends SocialNetwork {
    ...
    private id.pptik.semutangkot.easylogin.AccessToken accessToken;
    ...
    private FacebookCallback<LoginResult> loginCallback = new FacebookCallback<LoginResult>() {
        ...
        public void onSuccess(LoginResult loginResult) {
            ...
            accessToken = new id.pptik.semutangkot.easylogin.AccessToken.Builder(token)
                    .userId(userId)
                    .build();
    ...
    @Override
    public id.pptik.semutangkot.easylogin.AccessToken getAccessToken() {
        if (com.facebook.AccessToken.getCurrentAccessToken() != null && accessToken == null) {
            AccessToken facebookToken = AccessToken.getCurrentAccessToken();
            accessToken = new id.pptik.semutangkot.easylogin.AccessToken.Builder(facebookToken.getToken()).userId(facebookToken.getUserId()).build();
        }
        return accessToken;
    }
